 ...
 * @author user
 */
public class VentanaCrearRector extends javax.swing.JInternalFrame {

    private ControladorRector controladorRector;
    private Rector rector;

    /**
     * Creates new form VentanaCrearRector
     */
    public VentanaCrearRector(ControladorRector controladorRector) {
        initComponents();
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        rector = new Rector(nombre, cedula, apellido, correo, contraseña);
        controladorRector.create(rector);
        try {
            controladorRector.guardar();
        } catch (IOException ex) {
            Logger.getLogger(VentanaCrearRector.class.getName()).log(Level.SEVERE, null, ex);
        }
        JOptionPane.showMessageDialog(this, "Rector creado");
